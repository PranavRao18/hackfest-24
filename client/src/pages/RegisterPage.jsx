      ...
      <div className="bg-gray-700 p-8 rounded-[20px] shadow-md w-full max-w-md text-white">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input type="text" id="name" name="name" value={details.name} onChange={handleChange} className="w-full p-2 rounded bg-gray-800" required />
          </div>
          <div className="mb-4">
          ...
          <button type="submit" className="w-full bg-green-300 text-black p-2 rounded text-[1.2rem] font-medium">SUBMIT</button>
        </form>
